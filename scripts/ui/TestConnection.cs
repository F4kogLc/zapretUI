...
internal class TestConnection : IElement
{
    ...
    public void Render()
    {
        ...
        ImGuiUtils.Tooltip("Запускает запрет с агрументами из блокчека и тестирует хост на доступность\nРедактируя config.json - можно добавить любые аргументы для тестирования\nВозможно мой способ не точен и блокчек более эффективен");
